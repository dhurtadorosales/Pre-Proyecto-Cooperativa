...
Partial Class recursos_maestra_Default
    ...
    Private Sub recursos_maestra_Default_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        fvAltaSocio.ChangeMode(FormViewMode.Insert)
    ...
    Protected Sub btnAltaSocio_Click(sender As Object, e As EventArgs)
        MsgBox("Socio insertado correctamente")
        If IsPostBack Then
            fvAltaSocio.Enabled = False
            divRol.Visible = True
            btnAsignaRol.Visible = True
        End If
    End Sub
